 ...
 */
var PostMessagePage = /** @class */ (function () {
    function PostMessagePage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PostMessagePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PostMessagePage');
    };
    PostMessagePage = __decorate([
        Component({
