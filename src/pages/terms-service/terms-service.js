...
var TermsServicePage = /** @class */ (function () {
    function TermsServicePage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    TermsServicePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad TermsServicePage');
    };
    TermsServicePage.prototype.back = function () {
