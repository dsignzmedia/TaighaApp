 ...
 */
var EmailNotVerifiedPage = /** @class */ (function () {
    function EmailNotVerifiedPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    EmailNotVerifiedPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EmailNotVerifiedPage');
    };
    EmailNotVerifiedPage = __decorate([
        Component({
